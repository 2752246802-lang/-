...
const assets = {
  domesticMainOne: new URL('../主图/内贸/BQG隔膜泵.png', import.meta.url).href,
  domesticMainTwo: new URL('../主图/内贸/BQG隔膜泵2.png', import.meta.url).href,
  domesticMainThree: new URL('../主图/内贸/BQG隔膜泵3.png', import.meta.url).href,
  domesticMainFour: new URL('../主图/内贸/BQS排污水电泵.png', import.meta.url).href,
  domesticMainFive: new URL('../主图/内贸/BQS排污水电泵2.png', import.meta.url).href,
  domesticMainSix: new URL('../主图/内贸/6.png', import.meta.url).href,
  domesticMainSeven: new URL('../主图/内贸/7.png', import.meta.url).href,
  domesticMainEight: new URL('../主图/内贸/8.png', import.meta.url).href,
  domesticMainNine: new URL('../主图/内贸/9.png', import.meta.url).href,
  domesticMainTen: new URL('../主图/内贸/10.png', import.meta.url).href,
  domesticMainEleven: new URL('../主图/内贸/11.png', import.meta.url).href,
  domesticMainTwelve: new URL('../主图/内贸/12.png', import.meta.url).href,
  internationalMainOne: new URL('../主图/外贸/1.jpg', import.meta.url).href,
  internationalMainTwo: new URL('../主图/外贸/2.jpg', import.meta.url).href,
  internationalMainThree: new URL('../主图/外贸/3.jpg', import.meta.url).href,
  internationalMainFour: new URL('../主图/外贸/4.jpg', import.meta.url).href,
  internationalMainFive: new URL('../主图/外贸/5.jpg', import.meta.url).href,
  internationalMainSix: new URL('../主图/外贸/6.jpg', import.meta.url).href,
  internationalMainSeven: new URL('../主图/外贸/7.png', import.meta.url).href,
  internationalMainEight: new URL('../主图/外贸/8.png', import.meta.url).href,
  internationalMainNine: new URL('../主图/外贸/9.png', import.meta.url).href,
  internationalMainTen: new URL('../主图/外贸/10.png', import.meta.url).href,
  internationalMainEleven: new URL('../主图/外贸/11.jpg', import.meta.url).href,
  internationalMainTwelve: new URL('../主图/外贸/12.jpg', import.meta.url).href,
  btMiniExcavator: new URL('../国际站详情页/邦泰-12小挖.png', import.meta.url).href,
  btTenMiniExcavator: new URL('../国际站详情页/邦泰-10小挖.png', import.meta.url).href,
  aonesDrillOne: new URL('../国际站详情页/奥内斯-水井钻机1.png', import.meta.url).href,
  aonesDrillTwo: new URL('../国际站详情页/奥内斯-水井钻机2.png', import.meta.url).href,
  aonesBoreholeCamera: new URL('../国际站详情页/奥内斯-井下电视.png', import.meta.url).href,
  noliForkliftDetail: new URL('../国际站详情页/诺力-叉车.png', import.meta.url).href,
  amazonTableSkirt: new URL('../国际站详情页/Amazon桌裙.jpg', import.meta.url).href,
  noliHome: new URL('../店铺首页/诺力叉车.png', import.meta.url).href,
  jinshengyuanHome: new URL('../店铺首页/金盛源矿山设备.png', import.meta.url).href,
  zhongseHome: new URL('../店铺首页/中隧安防集团.png', import.meta.url).href,
  waterPump: new URL('../内贸详情页/邦泰-水泵.png', import.meta.url).href,
  haisien: new URL('../内贸详情页/海思恩-益生菌.png', import.meta.url).href,
  driedBeef: new URL('../内贸详情页/牧香记-牛肉干.png', import.meta.url).href,
  epicoGlucan: new URL('../内贸详情页/海思恩-爱彼可+葡聚糖.png', import.meta.url).href,
  lactoferrin: new URL('../内贸详情页/海思恩-乳铁蛋白.png', import.meta.url).href,
  lactoferrinEpico: new URL('../内贸详情页/海思恩-乳铁蛋白+爱彼可.jpg', import.meta.url).href,
  organicOats: new URL('../内贸详情页/有机燕麦片.png', import.meta.url).href,
  caseCoverOne: new URL('../精选案例封面/01.png', import.meta.url).href,
  caseCoverTwo: new URL('../精选案例封面/02.png', import.meta.url).href,
  caseCoverThree: new URL('../精选案例封面/03.png', import.meta.url).href,
  caseCoverFour: new URL('../精选案例封面/04.png', import.meta.url).href,
  zhaoluWebsite: new URL('../网站预览/赵鲁机械独立站.png', import.meta.url).href,
  bangtaiWebsite: new URL('../网站预览/邦泰机电官网.png', import.meta.url).href,
  heroPerson: new URL('../网站排版素材/人像.png', import.meta.url).href,
  heroPortrait: new URL('../个人照片/hero-portrait-cutout.png', import.meta.url).href,
  heroTitle: new URL('../网站排版素材/标题.png', import.meta.url).href,
  heroIntroCard: new URL('../网站排版素材/简介标签.png', import.meta.url).href,
  heroIntroTag: new URL('../网站排版素材/指向简洁标签.png', import.meta.url).href,
  heroProjectCard: new URL('../网站排版素材/小案例标签.png', import.meta.url).href,
  heroProjectTag: new URL('../网站排版素材/指向案例标签.png', import.meta.url).href,
  heroMenuCard: new URL('../网站排版素材/导航标签.png', import.meta.url).href,
  heroMenuTag: new URL('../网站排版素材/指向导航标签.png', import.meta.url).href,
  heroCamera: new URL('../网站排版素材/相机.png', import.meta.url).href,
  heroCameraTag: new URL('../网站排版素材/相机标签.png', import.meta.url).href,
  wechatQr: new URL('../个人微信二维码.png', import.meta.url).href,
  cameraSticker: new URL('../ai/camera-sticker.png', import.meta.url).href,
};
