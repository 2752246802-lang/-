...
const assets = {
  domesticMainOne: new URL('../主图/内贸/BQG隔膜泵 (1).webp', import.meta.url).href,
  domesticMainTwo: new URL('../主图/内贸/BQG隔膜泵2 (1).webp', import.meta.url).href,
  domesticMainThree: new URL('../主图/内贸/BQG隔膜泵3 (1).webp', import.meta.url).href,
  domesticMainFour: new URL('../主图/内贸/BQS排污水电泵 (1).webp', import.meta.url).href,
  domesticMainFive: new URL('../主图/内贸/BQS排污水电泵2 (1).webp', import.meta.url).href,
  domesticMainSix: new URL('../主图/内贸/6 (1).webp', import.meta.url).href,
  domesticMainSeven: new URL('../主图/内贸/7 (1).webp', import.meta.url).href,
  domesticMainEight: new URL('../主图/内贸/8 (1).webp', import.meta.url).href,
  domesticMainNine: new URL('../主图/内贸/9 (1).webp', import.meta.url).href,
  domesticMainTen: new URL('../主图/内贸/10 (1).webp', import.meta.url).href,
  domesticMainEleven: new URL('../主图/内贸/11 (1).webp', import.meta.url).href,
  domesticMainTwelve: new URL('../主图/内贸/12 (1).webp', import.meta.url).href,
  internationalMainOne: new URL('../主图/外贸/1 (1).webp', import.meta.url).href,
  internationalMainTwo: new URL('../主图/外贸/2 (1).webp', import.meta.url).href,
  internationalMainThree: new URL('../主图/外贸/3 (1).webp', import.meta.url).href,
  internationalMainFour: new URL('../主图/外贸/4 (1).webp', import.meta.url).href,
  internationalMainFive: new URL('../主图/外贸/5 (1).webp', import.meta.url).href,
  internationalMainSix: new URL('../主图/外贸/6 (1).webp', import.meta.url).href,
  internationalMainSeven: new URL('../主图/外贸/7 (1).webp', import.meta.url).href,
  internationalMainEight: new URL('../主图/外贸/8 (1).webp', import.meta.url).href,
  internationalMainNine: new URL('../主图/外贸/9 (1).webp', import.meta.url).href,
  internationalMainTen: new URL('../主图/外贸/10 (1).webp', import.meta.url).href,
  internationalMainEleven: new URL('../主图/外贸/11 (1).webp', import.meta.url).href,
  internationalMainTwelve: new URL('../主图/外贸/12 (1).webp', import.meta.url).href,
  btMiniExcavatorSlices: getSlices('邦泰-12小挖_1_meitu'),
  btTenMiniExcavatorSlices: getSlices('邦泰-10小挖_1_meitu'),
  aonesDrillOneSlices: getSlices('奥内斯-水井钻机1_1_meitu'),
  aonesDrillTwoSlices: getSlices('奥内斯-水井钻机2_1_meitu'),
  aonesBoreholeCameraSlices: getSlices('奥内斯-井下电视_1_meitu'),
  noliForkliftDetailSlices: getSlices('诺力-叉车_1_meitu'),
  amazonTableSkirtSlices: getSlices('Amazon桌裙_1_meitu'),
  noliHomeSlices: getSlices('诺力叉车_1_meitu'),
  bangtaiHomeSlices: getSlices('邦泰机电_1_meitu'),
  jinshengyuanHomeSlices: getSlices('金盛源矿山设备_1_meitu'),
  zhongseHomeSlices: getSlices('中隧安防集团_1_meitu'),
  waterPumpSlices: getSlices('邦泰-水泵_1_meitu'),
  haisienSlices: getSlices('海思恩-益生菌_1_meitu'),
  driedBeefSlices: getSlices('新建文件夹 (5)'),
  epicoGlucanSlices: getSlices('海思恩-爱彼可+葡聚糖_1_meitu'),
  lactoferrinSlices: getSlices('海思恩-乳铁蛋白_1_meitu'),
  lactoferrinEpicoSlices: getSlices('海思恩-乳铁蛋白+爱彼可_1_meitu'),
  organicOatsSlices: getSlices('新建文件夹 (6)'),
  ...
  zhaoluWebsite: new URL('../网站预览/昭禄机械独立站.webp', import.meta.url).href,
...
const projects = [
  ...
  },
  {
    ...
    platform: '国际站',
    images: assets.btMiniExcavatorSlices,
    tone: '工业设备',
  ...
  },
  {
    ...
    moduleId: 'international-visual',
    platform: '国际站',
    images: assets.aonesDrillOneSlices,
    tone: '机械设备',
  ...
  },
  {
    ...
    moduleId: 'international-visual',
    platform: '国际站',
    images: assets.aonesDrillTwoSlices,
    tone: 'B2B转化',
  ...
  },
  {
    ...
    moduleId: 'international-visual',
    platform: '国际站',
    images: assets.noliForkliftDetailSlices,
    tone: '物流设备',
  ...
  },
  {
    ...
    moduleId: 'international-visual',
    platform: '国际站',
    images: assets.aonesBoreholeCameraSlices,
    tone: '检测设备',
  ...
  },
  {
    ...
    moduleId: 'international-visual',
    platform: 'Amazon',
    images: assets.amazonTableSkirtSlices,
    tone: '跨境电商',
  ...
  },
  {
    ...
    moduleId: 'store-homepage',
    platform: '内贸阿里',
    images: assets.bangtaiHomeSlices,
    tone: '工程设备',
    summary: '围绕品牌实力、产品品类与采购入口梳理首页节奏，提升工业设备店铺的首屏承接与浏览效率。',
    tags: ['1688首页', '工程设备', '店铺视觉'],
  },
  {
    title: '金盛源矿山设备首页',
    type: '店铺首页设计',
    moduleId: 'store-homepage',
    platform: '内贸阿里',
    images: assets.jinshengyuanHomeSlices,
    tone: '矿山设备',
  ...
  },
  {
    ...
    moduleId: 'store-homepage',
    platform: '内贸阿里',
    images: assets.zhongseHomeSlices,
    tone: '安防行业',
  ...
  },
  {
    ...
    moduleId: 'domestic-detail',
    platform: '内贸电商',
    images: assets.epicoGlucanSlices,
    tone: '营养健康',
  ...
  },
  {
    ...
    moduleId: 'domestic-detail',
    platform: '内贸电商',
    images: assets.lactoferrinSlices,
    tone: '营养健康',
  ...
  },
  {
    ...
    moduleId: 'domestic-detail',
    platform: '内贸电商',
    images: assets.lactoferrinEpicoSlices,
    tone: '组合营养',
  ...
  },
  {
    ...
    moduleId: 'domestic-detail',
    platform: '内贸电商',
    images: assets.organicOatsSlices,
    tone: '食品电商',
